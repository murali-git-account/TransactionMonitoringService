...
/**
 * This generator listens to {@link Transaction} and generate the maximum of
 * transaction amounts
 */
public class MaxAmountStatTracker implements StatTracker {
    public static final String STAT_NAME = "max";
